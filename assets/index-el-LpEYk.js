 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Bf=xe("CircleAlert",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["line",{x1:"12",x2:"12",y1:"8",y2:"12",key:"1pkeuh"}],["line",{x1:"12",x2:"12.01",y1:"16",y2:"16",key:"4dfq90"}]]);/**
 * @license lucide-react v0.383.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const jf=xe("EyeOff",[["path",{d:"M9.88 9.88a3 3 0 1 0 4.24 4.24",key:"1jxqfv"}],["path",{d:"M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68",key:"9wicm4"}],["path",{d:"M6.61 6.61A13.526 13.526 0 0 0 2 12s3 7 10 7a9.74 9.74 0 0 0 5.39-1.61",key:"1jreej"}],["line",{x1:"2",x2:"22",y1:"2",y2:"22",key:"a6p6uj"}]]);/**
 * @license lucide-react v0.383.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const qf=xe("Eye",[["path",{d:"M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z",key:"rwhkz3"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);/**
 * @license lucide-react v0.383.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const bf=xe("Mail",[["rect",{width:"20",height:"16",x:"2",y:"4",rx:"2",key:"18n3k1"}],["path",{d:"m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7",key:"1ocrg3"}]]);/**
 * @license lucide-react v0.383.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Yf=xe("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]),Xf=[{id:"seed-001",category:"Walkaround / CDL",question:"How many static whips are on the plane and where are they located?",answer:`12 total static dischargers, all on control surfaces:
...
CAS messages are displayed to indicate the system has failed or is cutout.`}],Ga=Xf.map(e=>({...e,status:"new",created:"2024-01-01"})),Qi="phenom100_quiz_v1",Zf="quizfeedback@biter.com";function Jf(){const[e,t]=Q.useState([]),[n,r]=Q.useState(!0),[i,o]=Q.useState("All"),[s,a]=Q.useState("all"),[l,c]=Q.useState(0),[g,p]=Q.useState(!1),[h,w]=Q.useState(!1),[S,k]=Q.useState(!1),[W,d]=Q.useState(!1),[u,f]=Q.useState({category:"",question:"",answer:""}),[y,C]=Q.useState({category:"",question:"",answer:""});Q.useEffect(()=>{try{const E=localStorage.getItem(Qi);let q=[];E&&(q=JSON.parse(E));const ae=new Set(q.map(nt=>nt.id)),tt=Ga.filter(nt=>!ae.has(nt.id)),ze=[...q,...tt];(tt.length>0||q.length===0)&&localStorage.setItem(Qi,JSON.stringify(ze)),t(ze)}catch(E){console.error("load failed",E),t(Ga)}r(!1)},[]);const A=E=>{t(E);try{localStorage.setItem(Qi,JSON.stringify(E))}catch(q){console.error("save failed",q)}},N=["All",...Array.from(new Set(e.map(E=>E.category)))],P=i==="All"?e:e.filter(E=>E.category===i),R=s==="all"?P:P.filter(E=>E.status===s),F=R[l],ye=e.filter(E=>E.status==="known").length,Ct=e.filter(E=>E.status==="review").length,et=()=>{p(!1),k(!1),d(!1),c(R.length===0?0:(l+1)%R.length)},or=()=>{p(!1),k(!1),d(!1),c(R.length===0?0:(l-1+R.length)%R.length)},ki=()=>{p(!1),k(!1),d(!1),R.length>0&&c(Math.floor(Math.random()*R.length))},zt=E=>{if(!F)return;const q=e.map(ae=>ae.id===F.id?{...ae,status:E}:ae);A(q),et()},mn=()=>{if(!F)return;const E=e.filter(q=>q.id!==F.id);A(E),c(0),p(!1),k(!1)},x=()=>{F&&(f({category:F.category,question:F.question,answer:F.answer}),d(!0),p(!0))},L=()=>{if(!F||!u.category.trim()||!u.question.trim()||!u.answer.trim())return;const E=e.map(q=>q.id===F.id?{...q,category:u.category.trim(),question:u.question.trim(),answer:u.answer.trim()}:q);A(E),d(!1)},I=()=>{d(!1),f({category:"",question:"",answer:""})},j=()=>{if(!y.category.trim()||!y.question.trim()||!y.answer.trim())return;const E={id:"q-"+Date.now(),category:y.category.trim(),question:y.question.trim(),answer:y.answer.trim(),status:"new",created:new Date().toISOString().slice(0,10)},q=[...e,E];A(q),C({category:"",question:"",answer:""}),w(!1)};return n?m.jsx("div",{className:"min-h-screen bg-slate-950 flex items-center justify-center text-amber-400 font-mono",children:"Loading flight deck..."}):m.jsxs("div",{className:"min-h-screen text-slate-100 font-mono",children:[m.jsx("style",{children:`
